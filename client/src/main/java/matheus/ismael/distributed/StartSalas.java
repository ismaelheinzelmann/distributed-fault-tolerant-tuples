...
public enum StartSalas {
    ...
    CTC102(new Sala(new ArrayList<>(){{add("CTC101"); add("sim"); add("nao"); add("nao"); add("nao"); add("50");}})),
    ...
    CTC305(new Sala(new ArrayList<>(){{add("CTC304"); add("sim"); add("sim"); add("nao"); add("nao"); add("50");}}));
    final Sala sample;
}
