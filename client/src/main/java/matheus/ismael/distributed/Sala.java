...
public class Sala {
    ...
    public Sala(ArrayList<String> tuple) {
        nome = tuple.get(0);
        projetor = Boolean.parseBoolean(tuple.get(1));
        arCondicionado = Boolean.parseBoolean(tuple.get(2));
        computadores = Boolean.parseBoolean(tuple.get(3));
        mesaCompartilhada = Boolean.parseBoolean(tuple.get(4));
        capacidade = Boolean.parseBoolean(tuple.get(5));
    }
